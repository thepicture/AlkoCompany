...
namespace AlkoCompanyNew.Models.Entities
{
    ...
    public partial class AnalogiHouse
    {
        ...
        public virtual Nullable<float> AH_KorNaUsloviaFinansirovania { get; set; }
        ...
        public virtual Nullable<float> AH_KorNaPravaZemli { get; set; }
        public virtual Nullable<float> AH_KorNaMashtabZemli { get; set; }
        public virtual Nullable<float> AH_KorNaPravaDom { get; set; }
        ...
        public virtual string AH_TypeCanalizacia { get; set; }
        public virtual Nullable<float> AH_KorNaKanalizacia { get; set; }
        public virtual Nullable<float> AH_KorNaTechSostoyanie { get; set; }
